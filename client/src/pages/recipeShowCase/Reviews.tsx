  ...
  if (!recipeId) {
    return (
      <Card className="mt-8 border border-[#a84e24]/20 bg-[#fadaae]/50" id="reviews-section">
        ...
        <CardContent>
          <div className="text-gray-700 italic">Reviews can't display because you are not logged in.</div>
        </CardContent>
      </Card>
    )
  }
  ...
  if (!isLoggedIn) {
    return (
      <Card className="mt-8 border border-[#a84e24]/20 bg-[#fadaae]/50" id="reviews-section">
        ...
        <CardContent>
          <div className="bg-[#fef3d0] border border-[#a84e24]/20 rounded-md p-4">
            <p className="font-medium text-[#a84e24]">You need to be logged in to see reviews</p>
            <p className="text-gray-700 mt-2">
              Reviews are only available to registered users.
              <Link to="/account" className="text-[#a84e24] hover:underline font-medium ml-1">
                Log in or create an account
              </Link>{" "}
              to read existing reviews and share your own experience with this recipe.
            </p>
          </div>
        </CardContent>
      </Card>
